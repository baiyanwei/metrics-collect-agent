...
public class SNMPOperation extends MonitorOperation {
	...
	public void doIt(MonitoringTask task) throws PlatformException {
		try {
			...
			// throw new
			// PlatformException("invalid community in SNMP operation.");
			// }
			String mibs = task.getContent();
			...
			HashMap<String, String> messageInputAndRequestHeaders = this._monitoringWorkflow.getMessageInputAndRequestHeaders(this._operationID, mibs,
					new JSONObject(metricMap).toString());
